...
class Import extends Admin_Controller {
	...
	public function uploadproducts(){
		...
		//echo substr($_FILES['categoryfile']['name'], 0, 30);exit;
			...
			$fileExt	= substr($fileName, strrpos($fileName, '.') + 1);
						...
						if($post['category_ids']==18){
							...
							/*fashion category*/
							if($post['subcategory_ids']==7 || $post['subcategory_ids']==9){
							...
							}else if($post['subcategory_ids']==11){
							...
							}else if($post['subcategory_ids']==13){
							...
							}else if($post['subcategory_ids']==14){
