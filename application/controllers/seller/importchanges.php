													...
													if(count($data['errors'])<=0){
															foreach($totalfields as $data){
																	...
																	$adddetails=array(
																			...
																			//'internal_memeory' => isset($data[30])?str_replace(' ', '', strtoupper($data[30])):'',
													...
													if(count($data['errors'])<=0){
															foreach($totalfields as $data){
																	...
																	$adddetails=array(
																			...
																			'product_code' =>isset($data[19])?$data[19]:'',
																			'colour' =>isset($data[20])?$data[20]:'',
																			'type' =>isset($data[21])?$data[21]:'',
																			'waterproof' =>isset($data[22])?$data[22]:'',
																			'laptop_compartment' =>isset($data[23])?$data[23]:'',
																			'closure' =>isset($data[24])?$data[24]:'',
																			'focus_lock' =>isset($data[25])?$data[25]:'',
																			'wheels' =>isset($data[26])?$data[26]:'',
																			'no_of_copartments' =>isset($data[27])?$data[27]:'',
																			'no_of_pockets' =>isset($data[28])?$data[28]:'',
																			'inner_material' =>isset($data[29])?$data[29]:'',
																			'sole_material' =>isset($data[30])?$data[30]:'',
																			'product_dimension' =>isset($data[31])?$data[31]:'',
																			'ideal_for' =>isset($data[32])?$data[32]:'',
																			'item_image'=>isset($data[33])?trim($data[33]):'',
																			'item_image1'=>isset($data[34])?trim($data[34]):'',
																			'item_image2'=>isset($data[35])?trim($data[35]):'',
																			'item_image3'=>isset($data[36])?trim($data[36]):'',
