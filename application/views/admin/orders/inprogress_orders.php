  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="row">
       <div class="col-md-7">
           <h3 class="page-header"><i class="fa fa-list-ol" aria-hidden="true"></i>In-progress Orders</h3></div>
          <div class="col-md-5 pull-right">
         <form class="navbar-form" action="<?php echo base_url(); ?>admin/Orders/inprogress_search" method="post">
         ...
         <button class="btn btn-default" type="submit">Go!</button>
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-list-ol" aria-hidden="true"></i>In-progress Orders</li>
          </ol>
        </div>
      </div>
      <div class="row">
