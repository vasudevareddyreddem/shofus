  ...
  <section id="main-content">
    <section class="wrapper">
      ...
      <div class="row">
       <div class="col-md-7">
           <h3 class="page-header"><i class="fa fa-credit-card" aria-hidden="true"></i>Customer Payments</h3></div>
         ...
         <button class="btn btn-default" type="submit">Go!</button>
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-credit-card" aria-hidden="true"></i>Customer Payments</li>
          </ol>
        </div>
      </div>
     <div class="row">
   ...
   foreach($paymentsdata as $payments_data){
     ...
     ?>
               ...
               <!--    <td><?php  echo $payments_data->status; ?></td> -->
                   ...
                   <td style="color:<?php  if( $payments_data->status=='' || $payments_data->status=='0' ){echo "Red";}elseif($payments_data->status=='1'){echo "Green";}

         else{echo "Blue";} ?>;font-weight:bold">

        <?php  

        if($payments_data->status=='' || $payments_data->status=='0' ){echo "Un-paid";}
        elseif($payments_data->status=='1'){echo "Paid";}
        else{
          echo "N/A";
        }
        ?>
                   ...
                   <td>  <a href="<?php echo base_url(); ?>admin/payments/delete/<?php  echo $payments_data->customer_payment_id; ?>" onclick="return checkDelete('<?php  echo $payments_data->customer_payment_id; ?>')"><i class="fa fa-trash-o" style="font-size:18px"></i></a></td>
