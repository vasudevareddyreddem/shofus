    ...
    <div class="col-md-5">
      <div class="bnr_rgt">
        <h1 align="center"> Change Password </h1>
          ...
          <div class="form-group">
		  <form action="<?php echo base_url();?>seller_admin/login/changepassword/<?php echo $this->uri->segment('4'); ?>" method="post" enctype="multipart/form-data" onSubmit="return validateof();">
            <div class="col-md-12">
              <div class="row">
