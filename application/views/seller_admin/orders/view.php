                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <br />
                      ...
                      <form action="<?php echo base_url(); ?>seller_admin/orders/update/<?php echo $this->uri->segment(4); ?>" method="post">
            ...
            $total += doubleval($products["subtotal"]);
              ...
              $total=0; $cartData = unserialize($Ordersdata->cart_data); ?>
                    ...
                    <div class="form-group col-lg-10 col-xs-12">
                        ...
                        <label class="control-label col-lg-2 col-md-2 col-sm-2 col-xs-12" for="first-name"> Order Status
                        ...
                        <div class=" col-lg-10 col-md-10 col-sm-10 col-xs-12">
                          ...
                          <label class="control-label col-lg-3 col-md-2 col-sm-2 col-xs-12" for="first-name"><?php  if(isset($Ordersdata->status) && $Ordersdata->status!='' )
              ...
              echo '<span style="color:green">Completed</span>';  
                      ...
                      <div class="form-group col-lg-10 col-xs-12">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2">
                          ...
                          <button type="button" class="btn btn-primary" onclick="window.location='<?php echo base_url(); ?>seller_admin/orders';return false;"> <i class="fa fa-arrow-left"></i> Orders</button>
