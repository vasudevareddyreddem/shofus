 ...
 <!--main content start-->
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-danger" onclick="window.location='<?php //echo base_url(); ?>seller_admin/products/<?php //echo $this->uri->segment(4);?>/<?php //echo $this->uri->segment(5);?>';return false;">Cancel</button>-->
            </div>
			  <div id="hide123"></div>
  ...
  <script type="text/javascript">
		...
		({
		type: "POST",
		url: "<?php echo base_url();?>seller_admin/pricing/getajaxsubcat",
		data: dataString,
		cache: false,
 ...
 <script type="text/javascript">
		...
		({
		type: "POST",
		url: "<?php echo base_url();?>seller_admin/pricing/getajaxrefferal",
		data: dataString,
		cache: false,
		success: function(data)
		{
...
<script type="text/javascript" language="javascript">
    ...
    $.ajax({
    type: "POST",
    url: '<?php echo base_url() ?>seller_admin/pricing/getajaxcount',
...
$('#ssubmit').show();
   ...
   var closing_price = $("#closing_price").val();
    ...
    $.ajax({
    type: "POST",
    url: '<?php echo base_url() ?>seller_admin/pricing/getajaxweight',
...
<script type="text/javascript" language="javascript">
    ...
    $.ajax({
    type: "POST",
    url: '<?php echo base_url() ?>seller_admin/pricing/getajaxprofit',
