        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              <form action="<?php echo base_url(); ?>seller_admin/products/update/<?php echo $productdata->item_id;  ?>/<?php echo $productdata->category_id;  ?>" method="post" enctype="multipart/form-data" onSubmit="return scvalidateof();this.js_enabled.value=1;return true;">
