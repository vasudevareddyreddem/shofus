...
//echo '<pre>';print_r($searhitems);exit;
 ...
 if($searhitems['yes']==0){  ?>
  ...
  <?php }else{ ?>
	 <a  style="text-decoration:none;" href="<?php echo base_url('category/productview/'.base64_encode($searhitems['item_id'])); ?>"><li style="list-style-type:none;padding:5px 0px; font-size:16px;"><?php  echo ucfirst(strtolower($searhitems['item_name']));  ?> in <?php echo ucfirst(strtolower($searhitems['subcategory_name'])); ?></li> </a>
