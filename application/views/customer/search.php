...
foreach($detail as $searhitems){  
 if($searhitems['yes']==0){  ?>
	...
	<li style="list-style-type:none;"><a  style="text-decoration:none;" href="<?php echo base_url('category/view/'.base64_encode($searhitems['subcategory_id'])); ?>"><?php  echo ucfirst($searhitems['subcategory_name']);  ?></a></li> 
  <?php }else{ ?>
