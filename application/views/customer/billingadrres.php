       ...
       <div class="tab-content">
					<div class="title"><span>Billing Address</span></div>
					  <div class="table-responsive">
						<div  id="oldaddress" class=" col-md-10 col-md-offset-1">
						
						<?php //echo '<pre>';print_r($customerdetail);exit; ?>
						<form action="" method="post" name="billingaddress" id="billingaddress">
										...
										<div class="form-group">
										  ...
										  <input type="text" id="address2" name="address2" class="form-control"  value="<?php echo $customerdetail['address']; ?>" >
										</div> 
							 </div>
							 <div  id="newaddress" style="display:none;" class=" col-md-10 col-md-offset-1">
						...
						<form action="" method="post" name="billingaddress" id="billingaddress">
						  ...
						  <nav aria-label="Shopping Cart Next Navigation">
							<ul class="pager">
							  ...
							  <li class="next"><button style="float:right;" type="submit">Proceed to Checkout <span aria-hidden="true">&rarr;</span></button></li>
							</ul>
						  </nav>
					</form>
        </div>
