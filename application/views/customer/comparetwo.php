 ...
 <div class="panel panel-default panel-pricing">
		...
		<i style="position:absolute;right:36px;top:0;font-size:18px;background:#fff;border-radius:50%;padding:5px;" onclick="removefunction2('compare_items2');" class="fa fa-times" aria-hidden="true"></i>
