                                    ...
                                    <table class="table borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="col-md-2">
                                                    <div class="media">
                                                        <a class=" " href="#"> <img style="height:80px;width:auto;" class="media-object img-responsive" src="<?php echo base_url('uploads/products/'.$productslist['item_image']); ?>" style="width: 72px; height: 72px;"> </a>
