...
<div id="sucessmsg" style="display:none;"></div>
        ...
        <div class="col-md-5 col-md-offset-3 " id="con_scrol">
          ...
          <div class="title-detail" style="text-transform: uppercase;"><?php echo $products_list['item_name']; ?>&nbsp;<?php echo isset($products_list['colour'])?$products_list['colour']:''; ?>&nbsp;<?php echo isset($products_list['internal_memeory'])?$products_list['internal_memeory']:''; ?>&nbsp;<?php echo isset($products_list['ram'])?'('.$products_list['ram'].' Ram'.')':''; ?></div>
