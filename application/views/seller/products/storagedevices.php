...
<div class="clear"></div>
	...
	<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				...
				<input type="text" class="form-control" id="capacity" name="capacity"  value="<?php echo isset($item_details['capacity'])?$item_details['capacity']:''; ?>" >
			</div>
		</div>
		<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">DATA Rate</label>
				<input type="text" class="form-control" id="datarate" name="datarate"  value="<?php echo isset($item_details['datarate'])?$item_details['datarate']:''; ?>" >
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				...
				<input type="text" class="form-control" id="technology" name="technology"  value="<?php echo isset($item_details['technology'])?$item_details['technology']:''; ?>" >
			</div>
		</div>
	</div>
