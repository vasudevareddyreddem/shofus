...
<div class="clear"></div>
	...
	<div class="row">
		...
		<div class="col-md-6 form-group">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">Voltage Range</label>
				<input type="text" class="form-control" id="voltagerange" name="voltagerange" value="<?php echo isset($item_details['voltagerange'])?$item_details['voltagerange']:''; ?>" >
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6 form-group">
			<div class="form-group nopaddingRight san-lg">
				 <label for="exampleInputEmail1">Maximum Turbo Speed</label>
				<input type="text" class="form-control" id="turbospeed" name="turbospeed" value="<?php echo isset($item_details['turbospeed'])?$item_details['turbospeed']:''; ?>" >
			</div>
		</div>
		<div class="col-md-6 form-group">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">Integrated Graphics</label>
				<input type="text" class="form-control" id="graphics" name="graphics" value="<?php echo isset($item_details['graphics'])?$item_details['graphics']:''; ?>" >
			</div>
		</div>
	</div>
