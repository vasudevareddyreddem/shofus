...
<div class="clear"></div>
	...
	<div class="row">
		<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">Motherboard Series</label>
				<input type="text" class="form-control" id="series" name="series"  value="<?php echo isset($item_details['series'])?$item_details['series']:''; ?>" >
			</div>
		</div>
		<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">External Drive Bays</label>
				<input type="text" class="form-control" id="externaldrivebays" name="externaldrivebays"  value="<?php echo isset($item_details['externaldrivebays'])?$item_details['externaldrivebays']:''; ?>" >
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">Internal Drive Bays</label>
				<input type="text" class="form-control" id="internaldrivebays" name="internaldrivebays"  value="<?php echo isset($item_details['internaldrivebays'])?$item_details['internaldrivebays']:''; ?>" >
			</div>
		</div>
		<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">Front USB Port</label>
	...
	<div class="row">
		<div class="col-md-6 ">
			<div class="form-group nopaddingRight san-lg">
				<label for="exampleInputEmail1">Front USB / Mic Port</label>
				<input type="text" class="form-control" id="micport" name="micport"  value="<?php echo isset($item_details['micport'])?$item_details['micport']:''; ?>" >
			</div>
		</div>
	</div>
