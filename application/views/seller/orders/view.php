                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <br />
                      ...
                      <form action="<?php echo base_url(); ?>seller/orders/update/<?php echo $this->uri->segment(4); ?>" method="post">
              ...
              echo '<span style="color:green">Completed</span>';  
                      ...
                      <div class="form-group col-lg-10 col-xs-12">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-12 col-md-offset-2">
                          ...
                          <button type="button" class="btn btn-primary" onclick="window.location='<?php echo base_url(); ?>seller/orders';return false;"> <i class="fa fa-arrow-left"></i> Orders</button>
