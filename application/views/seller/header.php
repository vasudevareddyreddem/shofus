                ...
                <div class="modal-content ">
                    <div class="modal-header modal-header_ad">
                        <ul class="nav-tabs final-login">
                            <li class=""><a data-toggle="tab">Sign In</a>
                            </li>
                            <li><a data-toggle="tab">Register</a>
                            </li>
                        </ul>
        ...
        <h4 class="modal-title"> Enquiry form</h4>
                        ...
                        <div class="modal-body" style="padding:0px">
                            ...
                            <div style="position: absolute;top:50%;color:#ddd;right:42%;">
                                <p style="font-size:20px;"><b>Limited period offer</b>
                                </p>
                                <p style="font-size:20px;margin-left: 25px;">Free for 1 month</p>
                                <br>
                                <span id="bnt" style="background:#006a99;padding:5px 10px ;border-radius:5px;font-size:18px;margin-left: 50px;cursor: pointer;" class="" data-dismiss="modal" data-toggle="modal" data-target="#myModa2">Register Now</span>
                            </div>
