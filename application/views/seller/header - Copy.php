                  ...
                  <div class="modal-body pass_list">
                    <form method="post" id="forgot_submit">
                      ...
                      <div id="demo" class="collapse">
                        <input type="email" class="form-control" id="forgot_email" name="forgot_email" placeholder="Please enter Email id">
                      ...
                      <div id="pho" class="collapse">
                        <input type="text" class="form-control" maxlength="10" id="forgot_mobile" name="forgot_mobile" placeholder="Please enter Mobile No">
